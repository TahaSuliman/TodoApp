...
{
    /// <summary>
    /// اختبارات فشل الاتصال بقاعدة البيانات - نسخة معدلة وتعمل
    /// </summary>
    public class DatabaseConnectionTests
    {
        ...
        #region Helper Methods - إنشاء Exceptions بطريقة صحيحة

        /// <summary>
        /// إنشاء exception يحاكي Foreign Key error
        /// </summary>
        private Exception CreateForeignKeyException()
        {
        ...
        /// <summary>
        /// إنشاء exception يحاكي Duplicate Key error
        /// </summary>
        private Exception CreateDuplicateKeyException()
        {
            return new InvalidOperationException(
                "Violation of PRIMARY KEY or UNIQUE KEY constraint. Duplicate entry."
            );
        }

        /// <summary>
        /// إنشاء exception يحاكي Database Connection error
        /// </summary>
        private Exception CreateDatabaseConnectionException()
        {
            return new InvalidOperationException(
        ...
        {
            // Arrange
            var dbException = CreateDatabaseConnectionException();
        ...
        public async Task TodoService_CreateAsync_ReturnsForeignKeyError_WhenUserDoesNotExist()
        {
            ...
            var foreignKeyException = CreateForeignKeyException();
            _mockTodoRepo.Setup(r => r.AddAsync(It.IsAny<Todo>()))
                .ThrowsAsync(foreignKeyException);
